...
public class Alterar {
	...
	public Integer empresa() {
		String nomeEmpresa, nomeFantasiaEmpresa;
		Integer cnpj;
		Map<String, String> sql = new HashMap<String, String>();
		@SuppressWarnings("resource")
		Scanner scan = new Scanner(System.in);

		sql.put("TABELA", "EMPRESA");
		sql.put("COLUNAS", "NOMEEMPRESA, NOMEFANTASIA, CNPJ");
		...
		nomeFantasiaEmpresa = scan.nextLine();
		System.out.println("Digite o CNPJ da empresa:");
		cnpj = scan.nextInt();

		sql.put("VALORES", sql.get("VALORES") + "'" + nomeEmpresa + "', ");
